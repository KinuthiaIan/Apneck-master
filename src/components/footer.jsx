    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b>  Thika town, Jamia, 2nd floor</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at +254790299385</a></p> </div>
          ...
          <Link to='https://discord.com/register' id='footer-link' target='_blank' className='gap-3'>
          <BsDiscord />
          </Link>
          <Link to='https://twitter.com/home' id='footer-link' target='_blank' className='gap-3'>
          <BsTwitter />
          </Link>
          <Link to={'https://github.com/KinuthiaIan'} className='gap-3' id='footer-link'>
          <BsGithub />
          </Link>
          <Link to='https://slack.com/' id='footer-link' target='_blank' className='gap-3'>
          <BsSlack />
          </Link>
          </div>
        </div>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start">&copy;Developed by Ian Kinuthia 2024</p>
        </div>
        <div className="col-12 col-md-6">
